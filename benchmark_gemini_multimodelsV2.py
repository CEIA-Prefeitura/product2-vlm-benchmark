...
PROMPTS_DIR = Path(os.getenv("BENCHMARK_PROMPTS_DIR_GERAL", "./prompts/prompts_especialistas/casa_terrea"))
TIPO_PROMPT_LABEL = "analise_casa_terrea_gemini_v5" # Novo rótulo de prompt se for diferente

SYSTEM_PROMPT_FILE = PROMPTS_DIR / "gemini" / "system_prompt_gemini_casa_terrea_V4.txt" # Pode ser o mesmo system prompt
HUMAN_PROMPT_FILE = PROMPTS_DIR / "gemini" / "human_prompt_gemini_casa_terrea_V4.txt"   # Pode ser o mesmo human prompt
