...
def evaluate_categorical_field(
    ...
    for i, label in enumerate(labels):
        metrics_per_class[label] = {
            ...
            "support_predicted": int(pred_counts.get(label, 0)) # Contagem de predições para este label
        }
...
OPCOES_ESTRUTURA = ["alvenaria","concreto","mista","madeira tratada","metalica","adobe/taipa/rudimentar", "NA"]
OPCOES_ESQUADRIAS = ["ferro","aluminio","madeira","rustica","especial","sem", "NA"]
OPCOES_PISO = ["ceramica","cimento","taco","tijolo","terra","especial/porcelanato", "NA"]
OPCOES_FORRO = ["laje","madeira","gesso simples/pvc","especial","sem", "NA"]
OPCOES_INSTALACAO_ELETRICA = ["embutida","semi embutida","externa","sem", "NA"]
OPCOES_INSTALACAO_SANITARIA = ["interna","completa","mais de uma","externa","sem", "NA"]
OPCOES_REVESTIMENTO_INTERNO = ["reboco","massa","material ceramico","especial","sem", "NA"]
OPCOES_ACABAMENTO_INTERNO = ["pintura lavavel","pintura simples","caiação","especial","sem", "NA"]
OPCOES_REVESTIMENTO_EXTERNO = ["reboco","massa","material ceramico","especial","sem", "NA"]
OPCOES_ACABAMENTO_EXTERNO = ["pintura lavavel","pintura simples","caiação","especial","sem", "NA"]
OPCOES_COBERTURA = ["telha de barro","fibrocimento","aluminio","zinco","laje","palha","especial","sem", "NA"]
OPCOES_TIPO_IMOVEL = ["Residencial", "Comercial", "Industrial", "NA"]
